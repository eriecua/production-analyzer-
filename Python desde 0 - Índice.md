...
- [[37 - S10-B4 - Probar rutas validas e invalidas]] — Los tres ejes por los que entra información, el `KeyError` de un CSV al que le falta una columna, y por qué las rutas relativas de `salidas/` se resuelven contra el directorio del terminal y no contra el del script. Estado: validado.
